...
export type Tally = Node & {
  ...
  /** Reads a single `User` that is related to this `Tally`. */
...
export type User = Node & {
  ...
  /** Reads and enables pagination through a set of `Tally`. */
  talliesByUserId: TalliesConnection;
};


export type UserTalliesByUserIdArgs = {
  first?: Maybe<Scalars['Int']>;
  last?: Maybe<Scalars['Int']>;
  offset?: Maybe<Scalars['Int']>;
  before?: Maybe<Scalars['Cursor']>;
...
export type TallyFragmentFragment = (
  { __typename?: 'Tally' }
  & Pick<Tally, 'note' | 'value' | 'category'>
);
...
export type CurrentUserQuery = (
  ...
  & { userById?: Maybe<(
    ...
    & { talliesByUserId: (
      { __typename: 'TalliesConnection' }
      & Pick<TalliesConnection, 'totalCount'>
      & { nodes: Array<Maybe<(
        { __typename: 'Tally' }
        & Pick<Tally, 'id' | 'nodeId'>
        & TallyFragmentFragment
      )>> }
    ) }
...
export const UserFragmentFragmentDoc = gql`
  ...
  username
    ...
    `;
export const TallyFragmentFragmentDoc = gql`
